...
class CommandDescription:
    ...
    admin_commands = {
        ...
        'editteam': '✏️ Редактировать команду',
        'listteam': '📋 Список команд',
        'createtask': '➕ Создать задание',
        'edittask': '✏️ Редактировать задание',
        'listtask': '📋 Список заданий',
        'assigntask': '🔗 Привязка заданий',
        'resetleader': '🔄 Сброс лидера',
        'resettask': '🔄 Сброс прогресса',
    }
...
class TaskMessages:
    ...
    EDIT_NAME = "📝 Введите новое название задания (или /cancel):"
    EDIT_DESCRIPTION = "📝 Введите новое описание (или /cancel):"
    EDIT_MEDIA = "🖼 Отправьте новое фото/GIF/стикер (или /skip /cancel):"
    EDIT_LOCATION = "🏠 Введите новую локацию (или /cancel):"
    EDIT_CODE = "🔑 Введите новое кодовое слово (или /cancel):"
